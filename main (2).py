class Bankaccount:
  ...
  def display_balance (self):
     print("account balance for{}(account{}):.₹{}".format(self.__amount_holder_name,self.__amount_number,self.__amount_balance)) account=Bankaccount(account_number="123456",               
account_holder_name="lufnabanu",
